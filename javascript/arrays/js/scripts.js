$(document).ready(function() {
  $("form#favorites").submit(function(event) {
    ...
    var favorites2 = [favorites[1], favorites[0], favorites[2]];

    console.log(favorites2);

    $("#output1").text(favorites2[0]);
    $("#output2").text(favorites2[1]);
    $("#output3").text(favorites2[2]);

    $("#outputs").show();
  });

  $("form#beverages").submit(function(event) {
    event.preventDefault();
